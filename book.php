...
<link href="https://fonts.googleapis.com/css2?family=Fondamento:ital@0;1&family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Madimi+One&family=Martel:wght@700;800;900&family=Montserrat:wght@500&family=Poppins:wght@200&family=Spirax&display=swap" rel="stylesheet">
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <a href="book_buyer.php" style="margin-right:500px"><i class="fa fa-fw fa-user"></i> Login</a>
    ...
    <?php
        ...
        $r = "select * from bookshop where book_id=$a";
