...
@media screen and (max-width: 650px) {
  ...
  .hide-md-lg {
    ...
    <body>
    <div class="container">
  <form action="book_buyer_login.php">
    <div class="row">
...
<div class="bottom-container">
  <div class="row">
    <div class="col">
      <a href="book_buyer2.php" style="color:white" class="btn">Sign up</a>
    </div>
    <div class="col">
      <a href="book_buyer.php" style="color:white" class="btn">Forgot password?</a>
    </div>
  </div>
</div>
